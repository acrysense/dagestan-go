...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (rangeSliders) {
    rangeSliders.forEach(function (slider) {
      ...
      var instance = noUiSlider.create(slider, {
  ...
  var resetCheckboxes = function resetCheckboxes() {
    document.querySelectorAll('.tours-filter__checkbox .square-checkbox__input').forEach(function (checkbox) {
      checkbox.checked = false;
    });
  };
  var resetAllCalendars = function resetAllCalendars() {
    calendarInstances.forEach(function (instance) {
      return instance.clear();
    });
  };
  var resetAllSliders = function resetAllSliders() {
    sliderInstances.forEach(function (_ref) {
      var instance = _ref.instance,
        start = _ref.start,
        inputs = _ref.inputs;
      instance.set(start);
      inputs[0].value = start[0];
      inputs[1].value = start[1];
    });
  };
  ...
  var toursFilterBtn = document.querySelector('.tours-filter__btn');
  var toursFilterClear = document.querySelector('.tours-filter__clear');
  ...
  if (toursFilterBtn) {
    toursFilterBtn.addEventListener('click', function () {
      if (toursFilter && toursFilter.classList.contains('is--active')) {
        toursFilter.classList.remove('is--active');
      }
    });
  }
  if (toursFilterClear) {
    toursFilterClear.addEventListener('click', function (event) {
      event.preventDefault();
      resetCheckboxes();
      resetAllCalendars();
      resetAllSliders();
  ...
  if (upcomingToursSlider) {
    ...
    upcomingToursSlider.addEventListener('wheel', function (event) {
      if (Math.abs(event.deltaX) > Math.abs(event.deltaY)) {
        if (event.deltaX > 0) {
          myUpcomingToursSlider.slideNext();
        } else {
          myUpcomingToursSlider.slidePrev();
        }
        event.preventDefault();
      }
    });
  ...
  var popupsBtn = document.querySelectorAll('.popup-btn');
  var popupsClose = document.querySelectorAll('.popup__close');
  if (popups && popupsBtn && popupsClose) {
    // modals
    ...
    // modals btn
    popupsBtn.forEach(function (item, i) {
      item.addEventListener('click', function (event) {
        event.preventDefault();
        var modalID = item.dataset.id;
        document.querySelectorAll('.popup.is--active').forEach(function (child) {
  ...
  var lightbox = GLightbox({
    svg: {
      close: "<svg width=\"61\" height=\"61\" viewBox=\"0 0 61 61\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                    <path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M61 30.5C61 47.3447 47.3447 61 30.5 61C13.6553 61 0 47.3447 0 30.5C0 13.6553 13.6553 0 30.5 0C47.3447 0 61 13.6553 61 30.5ZM33.0143 30.9089L42.5292 21.3942L40.4079 19.2729L30.8261 28.8544L21.4023 19.2811L19.2644 21.3856L28.7874 31.0598L19.2726 40.5745L21.3939 42.6958L30.9756 33.1143L40.3994 42.6877L42.5374 40.5831L33.0143 30.9089Z\" fill=\"currentColor\"/>\n                    </svg>",
      next: "<svg width=\"17\" height=\"18\" viewBox=\"0 0 17 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                    <path d=\"M0 7.92677V10.0732H12.8788L6.97601 15.976L8.5 17.5L17 9L8.5 0.5L6.97601 2.02399L12.8788 7.92677H0Z\" fill=\"currentColor\"/>\n                    </svg>",
      prev: "<svg width=\"17\" height=\"18\" viewBox=\"0 0 17 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                    <path d=\"M17 7.92677V10.0732H4.12121L10.024 15.976L8.5 17.5L0 9L8.5 0.5L10.024 2.02399L4.12121 7.92677H17Z\" fill=\"currentColor\"/>\n                    </svg>"
    }
  });
});